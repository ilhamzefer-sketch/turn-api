alter table wallet_top_up_requests alter column package_code drop not null;
alter table wallet_top_up_requests drop constraint chk_wallet_top_up_requests_fixed_package;
alter table wallet_top_up_requests add constraint chk_wallet_top_up_requests_fixed_package check (
    (package_code is null
        ...
        and amount_azn between 0.10 and 99999999.90
        and coin_amount = amount_azn * 10)
    or (package_code is not null and (
