...
public record RegistrationPaymentSessionRequest(
        ...
        @Size(max = 161, message = "Kart sahibi maksimum 161 simvol ola bilər.") String cardHolder,
        @Size(max = 19, message = "Kart nömrəsi düzgün deyil.") String cardNumber,
        @Size(max = 5, message = "Kart tarixi düzgün deyil.") String expireDate,
        @Size(max = 4, message = "CVV düzgün deyil.") String cvv,
        @NotNull(message = "Qeydiyyat növü seçilməlidir.") RegistrationType registrationType
) {
}
